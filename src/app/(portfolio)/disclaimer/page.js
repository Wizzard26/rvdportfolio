            ...
            <main className={`${styles.disclaimer} main-content`}>
                ...
                <section>
                    <div className="content-inner">
                        ...
                        <p>Es werden <strong>weder Ihre IP-Adresse noch Ihr vollständiger Browser-Kennsatz gespeichert</strong>. Aus der IP-Adresse werden serverseitig ausschließlich ein grober Ländercode sowie ein nicht umkehrbarer Prüfwert (Hash) abgeleitet; die IP-Adresse selbst wird dabei sofort verworfen und nicht abgespeichert. Dieser Prüfwert wechselt in einem Rhythmus von rund 30 Tagen (kalendermonatsweise) und dient ausschließlich dazu, wiederkehrende Besuche innerhalb dieses Zeitraums statistisch zu erkennen. Über diesen Zeitraum hinaus ist keine Wiedererkennung möglich, ebenso wenig ein Rückschluss auf Ihre Person.</p>
                        <ul className={styles.listUl}>
