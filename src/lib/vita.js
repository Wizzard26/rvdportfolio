export const vitaEntries = [
    ...
    {
        "id": 8,
        "title": "Weiterbildung - JavaScript Developer",
        "company": "alfatraining Bildungszentrum GmbH",
        "description": "JavaScript, DOM-Manipulation mit JavaScript, JavaScript Vertiefung, Programmierrichtlinien, ECMA-Script Versionen, AJAX, Frameworks / Libraries, jQuery, NodeJS Single Page Application: ReactJS: Einführung, theoretische Betrachtung, Installation, Virtuelle DOM Funktionsweise und Vorteile, Komponenten, Verschachtelung, Parameterübergabe, Inhaltsupdate, Eventlistener VueJS: Einführung, theoretische Betrachtung, Virtuelles DOM, Bidirektionale Datenbindung, Expressions, Direktiven, Bindings, Eigene Direktiven, Computed Properties Komponenten",
        "start": "05/2021",
        "end": "07/2021"
    },
    {
        "id": 9,
        "title": "Weiterbildung - Certified PHP Developer",
        "company": "alfatraining Bildungszentrum GmbH",
        "description": "Programmierung von dynamischen Webseiten. Aufbauend auf Syntax, Steuerung der Programme durch Kontrollstrukturen, Integration von HTML und PHP sowie der Modularisierung durch Funktionen wird die vertiefte Administration der Datenbank MySQL Planung und Umsetzung einer komplexen Internetanwendung, Objektorientierte Anwendung mit Datenbankanbindung",
        "start": "07/2021",
        "end": "09/2021"
    },
    {
...
export const vitaPersonal =  [
    {
        "id": 1,
        "area": "Adresse und Kontakt:",
        "showheadline": true,
        "entries": [
            {
                "id": 1,
                "entry": "René van Dinter"
            },
            {
                "id": 2,
                "entry": "Schiffertorsstrasse 22"
            },
            {
                "id": 3,
                "entry": "21682 Stade"
    ...
    },
    {
        ...
        "entries": [
            {
                "id": 1,
                "entry": "Web: https://www.rene-van-dinter.de"
            },
            {
                "id": 2,
                "entry": "Mail: info@rene-van-dinter.de"
            }
        ]
    },
    {
        ...
        "entries": [
            {
                "id": 1,
                "entry": "+49 (0) 174 / 93 27 538"
            }
        ]
    },
    {
        "id": 4,
        "area": "Sprachkenntnisse:",
        "showheadline": true,
        "entries": [
            {
                "id": 1,
                "entry": "Deutsch: Muttersprache"
            },
            {
                "id": 2,
    ...
    {
        "id": 5,
        "area": "Qualifikationen:",
        "showheadline": true,
        "entries": [
            {
                "id": 1,
                "entry": "Ausbildung: Mediengestalter Digital & Print"
            },
            {
                "id": 2,
                "entry": "Fachrichtung: Gestaltung und Technik"
            }
        ]
    },
    {
        ...
        "entries": [
            {
                "id": 1,
                "entry": "Shopware 5: Certified Template Developer"
            },
            {
                "id": 2,
                "entry": "Shopware 6: Certified Template Designer"
            }
        ]
    },
    {
        ...
        "entries": [
            {
                "id": 1,
                "entry": "Alfatraining: JavaScript Developer"
            },
            {
                "id": 2,
                "entry": "Alfatraining: Certified PHP Developer"
            },
            {
                "id": 3,
        ...
        "entries": [
            {
                "id": 1,
                "entry": "IBB Zeugniss",
                "link": "/document/ibb-cert.pdf"
            },
            {
                "id": 2,
                "entry": "IHK Prüfungszeugnis",
                "link": "/document/ihk-cert.pdf"
            },
            {
                "id": 3,
                "entry": "Arbeitszeugnis Rhinos-Media",
                "link": "/document/rm-cert.pdf"
            },
            {
                "id": 4,
                "entry": "Arbeitszeugnis WEBversiert",
                "link": "/document/webv-cert.pdf"
            },
            {
                "id": 5,
